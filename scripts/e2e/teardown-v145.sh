...
stage "STAGE 1 — adopt projects (bnk down; clusters survive)" \
  120:v3-existing-conn 121:v4-existing-disco
...
stage "STAGE 2 — projects that own clusters" \
  114:v1-new-connected 117:v2-new-disco 119:bare-connected 118:bare-disconnected

stage "STAGE 3 — F5 License Proxy (its VSI is in Harbor's VPC)" 116:flp
stage "STAGE 4 — Harbor registry" 115:harbor
