...
All modules pin **roksbnkctl v1.49.0** (`sha256:bfd395b2…`). The four use cases
...
The sync ingests **9 modules** and **11 blueprints** at version **5.10.0** (the `harbor` module below comes from Forge itself, not this repo):
